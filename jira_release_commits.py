...
class JiraReleaseCommitExtractor:
    ...
    def get_tasks_in_release(self):
        ...
        print(f"Found {len(issues)} issues in release {release_name}")
        return issues
    ...
    def get_commit_ids_for_tickets(self, issues):
        ...
        print(f"Found {len(commits)} commits associated with the tickets")
        return commits
    ...
    def generate_cherry_pick_script(self, ordered_commits):
        ...
        for commit in ordered_commits:
            ...
            script_content.append(f"git cherry-pick {commit['commit_hash']}")
